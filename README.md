...
### 팀 소개
4차 산업 혁명 시대, 세상은 전례없는 속도로 변화하고 있습니다. 2022년에 혜성처럼 등장한 ChatGPT를 시작으로 Google의 Gemini, Anthropic의 Claude까지. 바야흐로 LLM의 시대라고 해도 과언이 아닙니다.
AI가 일상에서 우리의 의문을 해결해주고, 계획을 대신 짜주기도 합니다. 하지만 같은 AI라도 어떻게 질문하고, 활용하느냐에 따라 우리가 얻는 결과는 천차만별입니다. 
이러한 AI를 우리는 조금 더 똑똑하게 쓰고자 모이게 되었습니다.
계속 업데이트 되고 있는 AI처럼, 우리의 세계를 업데이트 중입니다.

***

## 2️⃣ 공통된 관심사 : 파이썬, LLM, 게임 개발
